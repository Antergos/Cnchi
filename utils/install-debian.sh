#!/bin/bash
sudo apt-get -y install git glade geany python3 python-cairo-dev python-gobject-dev python-dbus python3-mako hdparm upower parted dosfstools mtools ntfs-3g libtimezonemap1-dev gir1.2-timezonemap-1.0
