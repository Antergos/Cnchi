...
DESKTOPS = ["base", "cinnamon", "enlightenment", "gnome", "kde4", "mate", "openbox", "xfce"]

DESKTOPS_DEV = DESKTOPS + ["lxqt", "plasma5"]
...
ALL_FEATURES = ["aur", "bluetooth", "cups", "firefox", "fonts", "games", "graphic_drivers", "lamp", "lts", "office", "visual", "firewall", "smb"]

# Each desktop has its own available features
FEATURES = {
    'cinnamon' : ["aur", "bluetooth", "cups", "firefox", "firewall", "fonts", "games", "graphic_drivers", "lts", "office", "smb"],
    'gnome' : ["aur", "bluetooth", "cups", "firefox", "firewall", "fonts", "games", "graphic_drivers", "lts", "office", "smb"],
    'kde4' : ["aur", "bluetooth", "cups", "firefox", "firewall", "fonts", "games", "graphic_drivers", "lts", "office", "smb"],
    'plasma5' : ["aur", "bluetooth", "cups", "firefox", "firewall", "fonts", "games", "graphic_drivers", "lts", "office", "smb"],
    'mate' : ["aur", "cups", "firefox", "firewall", "fonts", "lts", "office", "games", "graphic_drivers", "smb"],
    'enlightenment' : ["aur", "bluetooth", "cups", "firefox", "firewall", "fonts", "games", "graphic_drivers", "lts", "office", "smb"],
    'base' : ["aur", "cups", "fonts", "lamp", "lts"],
    'openbox' : ["aur", "bluetooth", "cups", "firefox", "firewall", "fonts", "games", "graphic_drivers", "lts", "office", "smb", "visual"],
    'lxqt' : ["aur", "bluetooth", "cups", "firefox", "firewall", "fonts", "games", "graphic_drivers", "lts", "office", "smb"],
    'xfce' : ["aur", "bluetooth", "cups", "firefox", "firewall", "fonts", "games", "graphic_drivers", "lts", "office", "smb"]}
